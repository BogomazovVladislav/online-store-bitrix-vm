...
<head>
    ...
    <?
    Asset::getInstance()->addJs(SITE_TEMPLATE_PATH . "/js/modal/send_message.js");

    if($APPLICATION->GetCurPage() == '/add_basket/'){
        Asset::getInstance()->addJs(SITE_TEMPLATE_PATH . "/js/basket/addBasket.js");
        Asset::getInstance()->addCss(SITE_TEMPLATE_PATH . "/css/basket/addBasket.css");
    }
    ?>
